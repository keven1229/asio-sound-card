...
| D3 | 主控用 XU316-1024-QF60A（立创 ¥41.07） | 立创价格比 XU208（¥70）还低；8 核足够 6进6出+混音回环；引脚预算见 02 |
...
| D8 | **6进6出虚拟通道架构**：每对立体声在 Windows 自动拆分为独立播放/录音设备；PC 播放流回灌为回环输入 | 设备内完成"虚拟跳线"，替代 Voicemeeter 类软件路由，零额外延迟、零 CPU；通道名可定制 |
